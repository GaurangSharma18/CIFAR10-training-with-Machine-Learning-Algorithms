...
X_train = np.array(X_all.reshape(
    50000, 3, 32, 32).transpose(0, 2, 3, 1).astype("int32"))
...
model.add(tf.keras.layers.Conv2D(512, (3, 3), input_shape=(32, 32, 3),
          strides=(1, 1), padding="valid", activation=tf.nn.relu))
model.add(tf.keras.layers.MaxPool2D(pool_size=(2, 2), padding="valid"))

model.add(tf.keras.layers.Conv2D(64, (3, 3), strides=(
    1, 1), padding="valid", activation=tf.nn.relu))
model.add(tf.keras.layers.MaxPool2D(pool_size=(2, 2), padding="valid"))
