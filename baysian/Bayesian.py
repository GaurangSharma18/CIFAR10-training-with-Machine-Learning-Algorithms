...
def cifar10_color(X_for_test): 
    #images_all = np.array([], dtype = np.uint32)
    # make_image_resized=resize(X_for_test, (50000,1,1,3)); #actual size of X_all is 50000,32,32,3
    # reshapeIt=make_image_resized.reshape(50000,3) #no change in the result, just the structure got change
    # return reshapeIt
    X=X_for_test;
    ...
    return Xp
    #X=X_for_test;
    #make_image_resized=resize((50000,3)); #actual size of X is 40000,3072
    #return make_image_resized
